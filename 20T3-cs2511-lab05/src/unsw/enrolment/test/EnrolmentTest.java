...
public class EnrolmentTest {
    ...
    public static void main(String[] args) {
        ...
        Marks comp1511Grade = new Marks("Assignments");

        // Assign marks for comp1511
        // Give the student a passing mark for assignment 1
        Grade comp1511Assignment1 = new Grade("Ass1", 60, student, comp1511Offering);
        comp1511Grade.addAssignment(comp1511Assignment1);
        // Give the student a passing mark for milestone 1 of assignment 2
        Marks comp1511Assignment2 = new Marks("Ass 2");
        Grade Ass2_Milestone1 = new Grade("milestone1", 60, student, comp1511Offering);
        comp1511Assignment2.addAssignment(Ass2_Milestone1);

        // Give the student a passing mark for milestone 2 of assignment 2
        Grade Ass2_Milestone2 = new Grade("milestone2", 60, student, comp1511Offering);
        comp1511Assignment2.addAssignment(Ass2_Milestone2);
        comp1511Grade.addAssignment(comp1511Assignment2);
        // Give the student an assignment 2 mark which is the average of
        // milestone 1 and 2
        comp1511Assignment2.AverageMark();
        // Give the student a prac mark which is the sum of assignment 1
        // and 2
        comp1511Grade.getPracMarks();
        // Give the student a passing exam mark.
        Grade comp1511Finals = new Grade("FinalExam", 60, student, comp1511Offering);
        comp1511Grade.addAssignment(comp1511Finals);
        comp1511Enrolment.setGrade(comp1511Grade);
        //Check if passed
        if(comp1511Enrolment.hasPassed()){
            System.out.println("Passed Comp1511");
        }
